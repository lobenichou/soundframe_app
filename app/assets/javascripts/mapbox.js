                ...
                n = L.Control.extend({
                    ...
                    _shareClick: function (t) {
                        ...
                        var e = this._tilejson || this._map._tilejson || {}, i = encodeURIComponent(this.options.url || e.webpage || window.location),
                            ...
                            h = '<div style="position: relative; width: 100%; height: 0px; padding-bottom: 60%;"> <iframe width="100%" height="100%" style="position: absolute; left: 0px; top: 0px; zoom: 0.75 -moz-transform: scale(0.75); -moz-transform-origin: 0 0; -o-transform: scale(0.75); -o-transform-origin: 0 0; -webkit-transform: scale(0.75); -webkit-transform-origin: 0 0;" frameBorder="0" sandbox="allow-scripts allow-popups allow-same-origin" src="{{embed}}"></iframe></div>'.replace("{{embed}}", e.embed || window.location),
