                ...
                n = L.Control.extend({
                    ...
                    _shareClick: function (t) {
                        ...
                        var e = this._tilejson || this._map._tilejson || {}, i = encodeURIComponent(this.options.url || e.webpage || window.location),
                            ...
                            h = '<iframe width="100%" height="100%" frameBorder="0" sandbox="allow-scripts allow-popups allow-same-origin" src="{{embed}}"></iframe></div>'.replace("{{embed}}", e.embed || window.location),
