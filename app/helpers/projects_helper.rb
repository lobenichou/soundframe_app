    ...
    proj_trs.each do |proj_tr|
      unless proj_tr.latitude == nil
        ...
        mapped_tracks.each do |mapped_track|
          gon.permalink_url[mapped_track.id] = mapped_track.permalink_url
          gon.track_title[mapped_track.id] = mapped_track.title
          gon.track_image[mapped_track.id] = mapped_track.artwork_url
        end
      end
    end
  end
